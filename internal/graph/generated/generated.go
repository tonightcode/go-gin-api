...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.updateUserMobile":
		if e.complexity.Mutation.UpdateUserMobile == nil {
			break
		}

		args, err := ec.field_Mutation_updateUserMobile_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.UpdateUserMobile(childComplexity, args["data"].(model.UpdateUserMobileInput)), true

	case "Query.bySex":
		if e.complexity.Query.BySex == nil {
			break
		}

		args, err := ec.field_Query_bySex_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.BySex(childComplexity, args["sex"].(string)), true
...
var sources = []*ast.Source{
	{Name: "internal/graph/schemas/user.graphql", Input: `type User {
  id: String!
  name: String!
  sex: String!
  mobile: String!
...
func (ec *executionContext) field_Mutation_updateUserMobile_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
...
func (ec *executionContext) field_Query_bySex_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
...
func (ec *executionContext) _Mutation_updateUserMobile(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
	...
	args, err := ec.field_Mutation_updateUserMobile_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().UpdateUserMobile(rctx, args["data"].(model.UpdateUserMobileInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_bySex(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Query_bySex_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().BySex(rctx, args["sex"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputupdateUserMobileInput(ctx context.Context, obj interface{}) (model.UpdateUserMobileInput, error) {
	var it model.UpdateUserMobileInput
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "updateUserMobile":
			out.Values[i] = ec._Mutation_updateUserMobile(ctx, field)
		default:
